 ...
 <table>
  <tr>
    ...
    <td align="top" width="50%">
      <h3 align="center">Stay Suite</h3>
      <br />
      <div align="center">
        <a target="_blank" href="https://portal-stay-suite.vercel.app/login">
          <img 
            src="https://res.cloudinary.com/dfuvivihz/image/upload/v1770536858/ej4095kJHJKFMfkfk3_p7q0dk.webp"
        ...
        <br/>
        <p align="center">
          <a href="https://portal-stay-suite.vercel.app/" target="_blank">
            <img src="https://img.shields.io/static/v1?label=|&message=WEBSITE&color=1d1f21&style=flat&logo=icloud&logoColor=fff" />
          </a>
        </p>
        <p align="center">
          <strong>Built with React, Tailwind CSS, Node.js/Express, and MongoDB,</strong>
          Stay Suite is a full-stack rental management platform featuring real-time unit tracking, tenant management, and automated billing.
        </p>
      </div>
    </td>
    <!-- Project 2 -->
